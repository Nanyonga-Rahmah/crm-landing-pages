...
export default function ClientView({ lead }: ClientViewProps) {
  function InfoItem({
    label,
    value,
  }: {
  ...
  return (
    <div className="flex flex-col px-6 py-2">
      <h1 className="text-2xl font-bold mb-6 text-gray-500">Client Details</h1>
          ...
          <div className="mt-6">
            ...
            {lead.products.length > 0 ? (
              ...
              <p className="text-gray-800">
                No products associated with this client.
              </p>
            )}
          </div>
        </div>
