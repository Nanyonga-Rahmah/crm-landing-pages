...
export function SolutionServiceForm({ type, onClose, bType }: HomeFormProps) {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = data?.data?.products
          .filter(
            (product: { category: string }) => product.category === 'SOLUTIONS'
          )
            ...
            render={({ field }) => (
              <FormItem className="grid">
                ...
                <FormControl>
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <div className="flex items-center justify-between p-2 border rounded-xl cursor-pointer text-gray-400 text-xs">
                        <span>{field.value || 'Select contact method'}</span>
                        <span>
                          <ChevronDown className="h-5 w-5 text-gray-500" />
                        </span>
                      </div>
                    ...
                    <DropdownMenuContent>
                      ...
                      <DropdownMenuCheckboxItem
                        ...
                        onCheckedChange={() => field.onChange('Other')}
                      >
                        Other
                      </DropdownMenuCheckboxItem>
                    </DropdownMenuContent>
...
export default SolutionServiceForm;
