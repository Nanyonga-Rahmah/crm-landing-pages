...
export function SolutionVisit({ onClose }: { onClose: () => void }) {
    ...
    const fetchLeads = async () => {
      ...
      try {
        ...
        const filteredLeads = data.data.leads.filter(
          (lead: ILeads) => lead.businessType === 'SOLUTIONS'
        );
                  ...
                  <div className="relative">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild disabled={!!businessName}>
                        <ChevronDown className="h-5 w-5 text-gray-500 absolute right-0 top-2 mr-2" />
                      </DropdownMenuTrigger>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="New Solution Prospect"
                    {...field}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="col-span-2">
                ...
                <FormControl>
                  <Textarea
                    placeholder="Additional Information/ Feed back"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
